...
final class LvcFriendlyErrorsIntegrationTest
{
    ...
    private static void friendlyErrorsMapTypedUnloadedChunks()
    {
        ...
        IntegrationTestSupport.assertEquals("gitmatica.error.lvc_project.friendly_chunks_unloaded", message.translationKey(), "friendly key");
    ...
    private static void friendlyErrorsUseInterruptedMessageForRecoverySensitiveRestoreFailures()
    {
        ...
        IntegrationTestSupport.assertEquals("gitmatica.error.lvc_project.friendly_chunks_interrupted", message.translationKey(), "friendly key");
        IntegrationTestSupport.assertEquals("Checkout", message.args()[0], "operation display name");
    }
    ...
    private static void friendlyErrorsHideUnexpectedRawDetails()
    {
        ...
        IntegrationTestSupport.assertEquals("gitmatica.error.lvc_project.friendly_unexpected", message.translationKey(), "friendly key");
