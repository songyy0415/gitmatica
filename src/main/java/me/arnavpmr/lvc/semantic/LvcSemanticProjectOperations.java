...
import me.arnavpmr.lvc.task.LvcAuthoritativeClientSyncTask;
import me.arnavpmr.lvc.task.LvcSemanticRestoreEngine;
import me.arnavpmr.lvc.task.LvcSemanticScanMismatchSampler;
import me.arnavpmr.lvc.world.LvcWorldAccess;
import me.arnavpmr.lvc.world.LvcWorldBackend;
import me.arnavpmr.lvc.util.LvcLitematicExportFiles;
...
public final class LvcSemanticProjectOperations
{
    ...
    public static LvcProjectCreationResult createProject(Path gameRunDirectory, String repositoryName, LvcPlayerIdentity player,
                                                  Level world, AreaSelection selection) throws Exception
    {
        ...
        return new LvcProjectCreationResult(repositoryDirectory, commit.getName());
    }

    public static LvcEmptyProjectResult createEmptyProject(Path gameRunDirectory, String repositoryName,
                                                                   String dimensionId) throws Exception
    {
        ...
        return new LvcEmptyProjectResult(repositoryDirectory, displayName);
    }
    ...
    public static LvcSemanticScanResult scanSemanticChanges(Path repositoryDirectory, Level world) throws Exception
    {
        Objects.requireNonNull(repositoryDirectory, "repositoryDirectory");
        Objects.requireNonNull(world, "world");
        ...
        return LvcWorldAccess.runOnSemanticCaptureWorld(captureWorld, authoritativeWorld ->
        {
            ...
            return LvcSemanticScanResult.compare(siteId, expectedTrackedHashes, scan);
        });
    }

    public static LvcSemanticCheckoutPreflight preflightSemanticCheckout(Path repositoryDirectory, Level world) throws Exception
    {
        return preflightSemanticActiveSite(repositoryDirectory, world, "Semantic checkout preflight requires a semantic LVC project");
    }

    public static LvcSemanticCheckoutPreflight preflightSemanticClearArea(Path repositoryDirectory, Level world) throws Exception
    {
    ...
    public static LvcSemanticWorldClearResult clearSemanticArea(Path repositoryDirectory, Level world) throws Exception
    {
        Objects.requireNonNull(repositoryDirectory, "repositoryDirectory");
        Objects.requireNonNull(world, "world");
        ...
        return LvcWorldAccess.runOnSemanticCaptureWorld(restoreWorld, authoritativeWorld ->
        {
            ...
            return new LvcSemanticWorldClearResult(project.site().regions().size(), engine.restoredBlocks());
        });
    }
    ...
    public static LvcExportResult exportCommitToLitematic(Path repositoryDirectory, String commitId, Path outputDirectory) throws IOException
    {
        Objects.requireNonNull(repositoryDirectory, "repositoryDirectory");
        ...
        return new LvcExportResult(exportFile.path(), exportFile.fileName());
    }
    ...
    public static LvcUpdateAreasResult updateSemanticAreas(Path repositoryDirectory, LvcPlayerIdentity player,
                                                                   Level world, AreaSelection selection, String message) throws Exception
    {
        ...
        return new LvcUpdateAreasResult(result.commit(), result.manifest().site(activeSite.siteId()).regions().size());
    }

    private static LvcSemanticCheckoutPreflight preflightSemanticActiveSite(Path repositoryDirectory, Level world,
                                                                                          String nonSemanticError) throws Exception
    {
        ...
        return LvcWorldAccess.runOnSemanticCaptureWorld(restoreWorld, authoritativeWorld ->
        {
            ...
            LvcSemanticScanResult result = LvcSemanticScanResult.compare(project.siteId(), expectedTrackedHashes, scan);
            ...
            return new LvcSemanticCheckoutPreflight(result, project.site().regions().size());
        });
    }
    ...
    private static void syncPreflightMismatches(Path repositoryDirectory, ActiveSemanticProject project, Level authoritativeWorld,
                                                ...
                                                LvcSemanticScanResult result) throws IOException
    {
        if (!(authoritativeWorld instanceof ServerLevel serverWorld))
        {
            return;
                                                                      ...
                                                                      LvcManifest.Site site) throws IOException
    {
        ...
        for (String objectId : site.fullHashes().values())
        {
            ...
            byte[] bytes = LvcGitTreeReader.readCommitFile(repository, commit, objectPath);
