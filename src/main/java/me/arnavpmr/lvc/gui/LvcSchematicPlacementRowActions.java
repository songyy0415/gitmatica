...
{
    private static final String OPEN_FAILED_KEY = "gitmatica.error.lvc_project.open_from_placement_failed";
    ...
    public static void exportLoadedOverlay(LitematicaSchematic schematic)
    {
        ...
        if (repositoryDirectory == null)
        {
            ...
            LvcGuiMessages.show(MessageType.ERROR, "gitmatica.error.lvc_project.export_failed", "Not an LVC tracking overlay");
            return;
        }
        ...
        try
        {
            ...
            LvcGuiMessages.show(MessageType.SUCCESS, "gitmatica.message.lvc_project.exported", outputFile.fileName());
        }
        catch (Exception e)
        {
            ...
            LvcGuiMessages.show(MessageType.ERROR, "gitmatica.error.lvc_project.export_failed", e.getMessage());
        }
    }
    ...
    public static boolean closeProject(LitematicaSchematic schematic)
    {
        ...
        LvcGuiMessages.show(MessageType.SUCCESS, "gitmatica.message.lvc_project.closed", projectName);
        return true;
    }
