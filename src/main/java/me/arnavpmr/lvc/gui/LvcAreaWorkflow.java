...
final class LvcAreaWorkflow
{
    ...
    static void promptClearArea(GuiLvcProjectController controller)
    {
        ...
        catch (Exception e)
        {
            ...
            LvcGuiMessages.showTaskError(Operation.CLEAR_AREA, "gitmatica.error.lvc_project.clear_area_failed", e);
        }
    }
    ...
    static void discardChanges(GuiLvcProjectController controller)
    {
        ...
        {
            LvcGuiMessages.showTaskError(Operation.DISCARD_CHANGES, "gitmatica.error.lvc_project.discard_failed", e);
        }
    }
        ...
        LvcRemoteServerApplyTask task = LvcRemoteServerApplyTask.clear(
                ...
                LvcTaskCallbacks.of(
                        result ->
                        {
                            ...
                            LvcGuiMessages.show(MessageType.SUCCESS, "gitmatica.message.lvc_project.remote_clear_sent",
                                    LvcOperationCoordinator.regionCountText(result.regionCount()));
                            showLossyRemoteWarning(result);
                        },
                        e -> LvcGuiMessages.showTaskError(Operation.CLEAR_AREA, "gitmatica.error.lvc_project.clear_area_failed", e, true),
                        () -> LvcGuiMessages.show(MessageType.INFO, "gitmatica.message.lvc_project.task_aborted", "LVC Clear Area")
                )
        );
    ...
    static void scheduleClear(GuiLvcProjectController controller, LvcOperationHandle handle, Level restoreWorld)
    {
        LvcSemanticClearTask task = new LvcSemanticClearTask(
                ...
                LvcTaskCallbacks.of(
                        ...
                        {
                            controller.refreshTrackingOverlayAfterWorldMutation();
                            LvcGuiMessages.show(MessageType.SUCCESS, "gitmatica.message.lvc_project.clear_area_cleared",
        ...
        LvcSemanticDiscardTask task = new LvcSemanticDiscardTask(
                ...
                LvcTaskCallbacks.of(
                        result ->
                        {
                            ...
                            if (!result.discarded())
                            {
                                LvcGuiMessages.show(MessageType.ERROR, "gitmatica.error.lvc_project.no_changes_to_discard");
                                return;
                            }
                            ...
                            {
                                LvcGuiMessages.show(MessageType.SUCCESS, "gitmatica.message.lvc_project.discarded_changes",
                                        LvcOperationCoordinator.regionCountText(result.restoredRegionCount()));
                            }
                            else
                            {
                                LvcGuiMessages.show(MessageType.SUCCESS, "gitmatica.message.lvc_project.discarded_changes_no_regions");
                            }
                        },
                        e -> LvcGuiMessages.showTaskError(Operation.DISCARD_CHANGES, "gitmatica.error.lvc_project.discard_failed", e, true),
                        () -> LvcGuiMessages.show(MessageType.INFO, "gitmatica.message.lvc_project.task_aborted", "LVC Discard Changes")
                )
        );
    ...
    {
        if (!LvcConfigs.Generic.SHOW_DISCARD_CHANGES_WARNING.getBooleanValue())
        {
        ...
        GuiBase.openGui(new GuiLvcWarningConfirmDialog(
                ...
                "gitmatica.gui.title.lvc_project.confirm_discard_changes",
                "gitmatica.gui.message.lvc_project.confirm_discard_changes",
                LvcConfigs.Generic.SHOW_DISCARD_CHANGES_WARNING,
                "LVC Discard Changes",
                confirmed,
                () -> {}
        ));
    ...
    {
        if (!LvcConfigs.Generic.SHOW_CLEAR_AREA_WARNING.getBooleanValue())
        {
        ...
        GuiBase.openGui(new GuiLvcWarningConfirmDialog(
                LvcOperationCoordinator.confirmParent(controller),
                "gitmatica.gui.title.lvc_project.confirm_clear_area",
                "gitmatica.gui.message.lvc_project.confirm_clear_area",
                LvcConfigs.Generic.SHOW_CLEAR_AREA_WARNING,
                "LVC Clear Area",
                () -> scheduleClear(controller, handle, restoreWorld),
