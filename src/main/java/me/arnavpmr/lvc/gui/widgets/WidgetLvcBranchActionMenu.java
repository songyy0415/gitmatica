...
public class WidgetLvcBranchActionMenu extends WidgetBase
{
    ...
    public enum Action
    {
        CREATE("gitmatica.gui.button.lvc_project.branch_action_create"),
        DELETE("gitmatica.gui.button.lvc_project.branch_action_delete"),
        RENAME("gitmatica.gui.button.lvc_project.branch_action_rename"),
        MERGE("gitmatica.gui.button.lvc_project.branch_action_merge");
