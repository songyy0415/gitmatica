...
class GuiLvcDeleteBranchDialog extends GuiDialogBase
{
    ...
    GuiLvcDeleteBranchDialog(GuiLvcProjectController controller, List<String> branches)
    {
        ...
        this.title = StringUtils.translate("litematica.gui.title.lvc_project.delete_branch");
    ...
    protected void drawContents(GuiContext ctx, int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawStringWithShadow(ctx, StringUtils.translate("litematica.gui.label.lvc_project.delete_branch_select"),
    ...
    {
        String deleteLabel = StringUtils.translate("litematica.gui.button.lvc_project.branch_action_delete");
    ...
    private void deleteSelectedBranch()
    {
        ...
        {
            this.closeGui(true);
            LvcGuiMessages.show(MessageType.SUCCESS, "litematica.message.lvc_project.branch_deleted", deletedBranchName);
        }
    }
